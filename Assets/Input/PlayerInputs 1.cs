...
//     version 1.11.2
//     from Assets/Input/PlayerInputs 1.inputactions
//
...
public partial class @PlayerInputs1: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputs1()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerInputs1.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Boat.enabled, "This will cause a leak and performance issues, PlayerInputs1.Boat.Disable() has not been called.");
    }
    ...
    {
        private @PlayerInputs1 m_Wrapper;
        public BoatActions(@PlayerInputs1 wrapper) { m_Wrapper = wrapper; }
